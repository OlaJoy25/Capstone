            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                ...
                <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                    <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="./olan.png" alt="Bonnie Avatar" />
                        </a>
                        <div class="p-5">
                            <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="https://www.linkedin.com/in/joycelyn-ajike-407b85204">Joycelyn Ola Ajike</a>
                            </h3>
                    ...
                    <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="p-5">
                            <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="https://www.linkedin.com/in/olayinka-naa-dzama-wilson-kofi-08a4aa7/">Olayinka Naa Dzama Wilson-Kofi</a>
                            </h3>
                    ...
                    <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="p-5">
                            <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="https://www.linkedin.com/in/sunday-azeez-695042188/">Azeez Sunday Arisekola</a>
                            </h3>
                            <span class="text-gray-500 dark:text-gray-400">GRC officer</span>
                            <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Sunday is our trusted officer. She has a solid background in Governance, Risk, and Compliance (GRC) and carefully aligns our cybersecurity tactics with industry standards and regulatory regulations, strengthening our clients' risk management frameworks with accuracy and foresight.</p>
                            <ul class="flex space-x-4 sm:mt-0">
                                <li>
                                    <svg
                                        className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="p-5">
                            <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="https://www.linkedin.com/in/faiza-seidu-adam-591261132/">Faiza Seidu-Adam</a>
                            </h3>
